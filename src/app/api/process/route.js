...
import { compactTaxonomy, SFDC_VOICE_RULES } from "@/lib/sfdcTaxonomy";
...
APPROVED TYPE AND SUBTYPE OPTIONS — copy these strings EXACTLY into Salesforce (Subtype must come from the chosen Type's list)
${compactTaxonomy()}
